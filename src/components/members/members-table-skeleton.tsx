 ...
 * the first data column (ADMIN-4). The real table now emits 10 (no
 * selection, manager view) or 11 (with selection, admin view).
 * Default is 10 (no selection — manager + first-paint baseline) so a
