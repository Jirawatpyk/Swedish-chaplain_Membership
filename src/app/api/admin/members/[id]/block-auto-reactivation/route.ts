 ...
 * carries `F8.MEMBER_BLOCK_AUTO_REACTIVATION` with some suffix — so an alert keyed on `F8.MEMBER_BLOCK_AUTO_REACTIVATION.*` matches those.
 *
 ...
 */
const ERROR_ID = 'F8.MEMBER_BLOCK_AUTO_REACTIVATION';
