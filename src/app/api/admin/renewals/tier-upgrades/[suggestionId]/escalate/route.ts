 ...
 * carries `F8.ESCALATE_TIER` with some suffix — so an alert keyed on `F8.ESCALATE_TIER.*` matches those.
 *
 ...
 */
const ERROR_ID = 'F8.ESCALATE_TIER';
      ...
      switch (result.error.kind) {
        ...
        case 'server_error':
          ...
          logger.error(
            ...
            'admin.renewals.tier_escalate_server_error',
          );
          return errorResponse({
            status: 500,
            code: 'server_error',
