 ...
 * container so a throw on the payment-success confirmation doesn't bubble to the
...
export default function PortalRenewalSuccessError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[portal renewal success error boundary]', error);
  }, [error]);
