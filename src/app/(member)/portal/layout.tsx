 ...
 *
 * Renders the persistent header with UserMenu + ThemeToggle (same
 * pattern as the staff shell) so the sign-out affordance is always
 * one click away.
 */
export default async function MemberLayout({ children }: { children: ReactNode }) {
  ...
  // (e.g., deep-link click after a role change). Redirect to their
  // own portal.
