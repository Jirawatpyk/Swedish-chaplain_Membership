 ...
 *
 * Logos are PUBLIC (the re-encoded image appears in published outputs — E-Book
 * embed + JSON reference — and Vercel Blob doesn't gate image fetches behind
 * auth). `addRandomSuffix: true` makes the URL unguessable, and only the
