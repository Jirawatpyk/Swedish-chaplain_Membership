...
// here made `renewalsMetrics.pruneAutoDraftsErrors` undefined, so the success
// path threw into the route's own catch and answered 500 — the test read as a
// route bug when it was a stale stub. (Surfaced 2026-07-28 by the new
// quality-gates CI job; pre-push never ran tests/unit/**.)
...
vi.mock('@/lib/metrics', () => ({
  renewalsMetrics: {
    ...
    pruneAutoDraftsErrors: errorsMock,
