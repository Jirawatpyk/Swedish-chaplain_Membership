...
function makeBroadcastsRepo(opts: FixtureOpts = {}): BroadcastsRepoStub {
  ...
  return {
    ...
    async deleteExpiredForRetention() { throw new Error('not used in submit-broadcast fixture'); },
    async listExpiredForRetention() { throw new Error('not used in submit-broadcast fixture'); },
...
function makeBroadcast(input: NewBroadcastDraftInput): Broadcast {
  return {
    ...
    // T086 — the Contacts-Import build (migration 0298).
