...
| 8 | T104 erasure severs suppression back-references | unit 3 × (`suppressionRefsSevered` undefined / sever spy not called / sever error swallowed); live Neon `erasure-severs-suppression-refs.test.ts` 2 × output undefined | unit 11/11; live 2/2 + `erase-member-f7-content` (real F3 erasure path) 7/7; typecheck 0 | (this commit) |
