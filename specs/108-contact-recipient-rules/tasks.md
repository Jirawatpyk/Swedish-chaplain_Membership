...
- [ ] T097 [P] Docs: `CLAUDE.md` (migration counter 0291→0297 — 0298 deferred with T086, Recent Changes entry, Active Technologies "PLANNED" → shipped), `docs/changelog.md`, `docs/contacts-primary-secondary-gap-analysis.md` status line (H1/H2/G1–G9 closed; G3 kept)
