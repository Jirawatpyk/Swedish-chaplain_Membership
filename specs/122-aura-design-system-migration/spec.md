...
- AURA 5.5.0 covers handoff items 1–51 (5.6.0 adds 52–56; 5.7.0, the pin since US1, adds 57–62) and exposes the same package entry points as 4.17 (verified on the registry 2026-09-26); item 63 (SideNav label wrap) is open.
