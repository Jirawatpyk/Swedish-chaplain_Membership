...
- [ ] T004 [P] Add `RESEND_BROADCASTS_API_KEY`, `RESEND_BROADCASTS_WEBHOOK_SECRET`, `UNSUBSCRIBE_TOKEN_SECRET`, `FEATURE_F7_BROADCASTS` to `vercel env add` for `development`, `preview`, `production` (run via Vercel CLI, NOT committed). **User-driven manual step — out of scope for code edits.**
