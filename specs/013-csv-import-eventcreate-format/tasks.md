...
- [ ] T058 [Operator gate] cron-job.org dashboard entry — daily 05:00 Asia/Bangkok hit on `/api/internal/retention/sweep-error-csv-blobs` with Bearer `CRON_SECRET`; configure email alert on ≥2 consecutive day failures per E5. Commit URL/ID to `docs/runbooks/cron-jobs.md` alongside F4/F5/F7/F8 entries
