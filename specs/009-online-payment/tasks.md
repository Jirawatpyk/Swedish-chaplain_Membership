...
- [X] T067 [P] [US1] Implement `src/modules/payments/infrastructure/audit/payments-audit.ts` — emits the 16 audit event types with correct `retention_years` per data-model.md § 7.1 mapping (5 or 10).
