...
- [ ] All 15 audit event types in spec FR-020 are emitted with the correct severity + payload schema (verified by `tests/integration/payments/audit-coverage.test.ts` to be added in `/speckit.implement` Phase 4).
