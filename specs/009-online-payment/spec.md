...
- **SC-011** *(reconciliation variance)*: Month-end variance between the Chamber-OS online-payments ledger and the processor dashboard is **zero THB** for three consecutive months. Non-zero variance triggers a postmortem.
