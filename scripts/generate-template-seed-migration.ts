 ...
 * emits `drizzle/migrations/0168_f71a_default_template_seed.sql`.
 *
 ...
 *     → writes drizzle/migrations/0168_f71a_default_template_seed.sql
 *
...
const TARGET_SQL = resolve(
  ...
  'drizzle',
  'migrations',
  // Migration numbering: F14 originally targeted 0127-0134, but 012 worktree
  // shipped F6 + F1 hardening migrations on the same Neon main branch
  // occupying 0127-0160. F14 renumbered to 0161-0168 (this is 0168) to land
  // after 012's contribution per Phase 2 renumber decision 2026-05-18.
  '0168_f71a_default_template_seed.sql',
);
...
function emitSql(rows: readonly TemplateRow[]): string {
  const header = `-- F7.1a US7 default template seed (T019; FR-020; renumbered 0134→0168 per Phase 2 plan) — AUTO-GENERATED.
--
