...
- `.specify/memory/constitution.md` — **v1.2.0**, authoritative. 10 principles (4 NON-NEGOTIABLE: Data Privacy & Security, Test-First, Clean Architecture, PCI DSS) plus 6 Core (i18n, Inclusive UX, Perf & Observability, Reliability, Code Quality, Simplicity). Amendments go through a PR with ≥2 maintainer approvals and a Sync Impact Report.
