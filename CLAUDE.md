...
- Postgres advisory-lock per `(tenant_id, invoice_id)` + idempotency key `inv-{invoice_id}-{attempt_seq}` — concurrent-initiate guard (R2-E2) (009-online-payment)
