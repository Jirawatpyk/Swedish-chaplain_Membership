...
| 2 | บัญชี **ไม่ผูกบริษัท** → เปิด `/portal/account` | ส่วน Renewal + Data & privacy ถูกซ่อน; ส่วน Account ยังใช้ได้ (มีปุ่ม Sign out อยู่ในนั้น) |
...
| # | ขั้นตอน | ผลที่คาดหวัง |
|---|---|---|
| 1 | `/portal/account` → การ์ด Account → ปุ่ม **"Sign out"** (ท้ายการ์ด) | ออกจากระบบ → กลับหน้า sign-in |
