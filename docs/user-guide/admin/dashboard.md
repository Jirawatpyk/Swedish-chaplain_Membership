...
4. มีผลเยอะ → ใช้ปุ่มเลื่อนหน้าท้ายตาราง: **Older** (เก่ากว่า) · **Newer** (ใหม่กว่า) · **Latest** (กลับหน้าใหม่สุดคลิกเดียว) — เป็น keyset ไม่เพี้ยนแม้มีเหตุการณ์ใหม่เข้ามาระหว่างเปิดดู
