...
> ℹ️ **From-name** = ชื่อหอการค้า (tenant display name เช่น "SweCham") เท่านั้น และ **Reply-To** = primary contact email ของสมาชิกผู้ส่ง — แก้ไม่ได้ (กันการสวมรอย: ไม่ใช้ชื่อสมาชิกเป็นชื่อผู้ส่ง แต่ reply จะวิ่งกลับเข้าอีเมลของสมาชิก)
