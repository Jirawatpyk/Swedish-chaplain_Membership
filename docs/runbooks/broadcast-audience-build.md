...
What does NOT change with the flag (see quickstart § Rollback matrix): the FR-021 active-only narrowing, the removal of the silent 5,000 cut, the fail-closed bridge reads and the compose UI (live count, hints) all ship UNFLAGGED.
